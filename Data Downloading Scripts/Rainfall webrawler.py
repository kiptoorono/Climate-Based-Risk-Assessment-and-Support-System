                ...
                try:
                    ...
                    if response.status_code==200:
                        with open(file_path,'wb') as file:
                            ...
                            print(f'downloaded{new_url}: status code{response.status_code}')
                    else:
                        print(f'failed to download from{new_url} statuscode:{response.status_code}')
...
directory_url= 'https://gws-access.jasmin.ac.uk/public/tamsat/rfe/data/v3.1/dekadal/'
download_path = 'E:\Agriculture project\Data\Raw data\Rainfall data'
